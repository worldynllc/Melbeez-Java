...
public class PaymentIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        Stripe.apiKey = "sk_test_mockkey123"; // set directly
    }
    ...
    void testCreateCheckoutSession_Success() throws Exception {
        ...
        details.put("warrantyId", "46439503");
        details.put("userId", "041e5b96-5926-4a25-b441-4597c2fc2355");
        ...
        when(warrantyRepository.findByWarrantyId("46439503"))
        ...
        UserResponseBaseModel mockUser = new UserResponseBaseModel();
        mockUser.setId("041e5b96-5926-4a25-b441-4597c2fc2355");
        mockUser.setUsername("John Doe");
        mockUser.setEmail("john.doe@example.com");
        when(aspNetUserRepository.findById("041e5b96-5926-4a25-b441-4597c2fc2355"))
        ...
        try (MockedStatic<Session> mockedSession = mockStatic(Session.class);
            ...
            when(mockCustomer.getId()).thenReturn("cus_mock_123");
